...
function gdq_aa_post( $atts, $content = null ){
	...
	// Wrap everything in the colors we want. Pull out the "Name" attributed to the post and the content then display it.
	return '<div class="aapost"><span style="color: #FFF; font-weight: bold; border-bottom: 1px solid #15911D; padding-bottom: 2px;">' . $atts['name'] . $nwxgdqsrc . '</span><span style="position: absolute; top:0; right:0; width:30px; height:30px;"><img src=" ' . plugins_url( 'imgs/aalogo.png', __FILE__ ) .'"></span> <p> ' . $content . '</p></div>';
